...
<body>
	<div id="page">
			<table>
				...
				<tbody>
					<tr v-for="(user,index) in userList">
						<td><input type="text" id="'userId' + index" :value="user.userId"></td>
						<td><input type="text" id="'password' + index" :value="user.password"></td>
			...
			<div>
				...
				</select> <input type="button" value="生成" @click="transfer()">
			</div>
	</div>
